<template>
  ...
  <hr>
  <div class="d-flex flex-column px-3 h-73">
    <textarea name="" id="" cols="30" rows="10" placeholder="Que Sucedió Hoy?"></textarea>
  </div>
  <FabAction 
    icon="fa-save"
  /> 
  <img src="https://www.robertlandscapes.com/wp-content/uploads/2022/04/CHESSWOOD-7.jpg" 
