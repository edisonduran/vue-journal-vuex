  ...
  <template v-if="entry">
    <div class="entry-title d-flex justify-content-between p-2">
      <div>
        ...
        <span class="mx-2 fs-4 fw-light"> {{ year }} , {{ dayWeek }} </span>
    ...
    <FabAction icon="fa-save" @on:click="saveEntry" />
    <!-- <img src="https://www.robertlandscapes.com/wp-content/uploads/2022/04/CHESSWOOD-7.jpg" alt="Entry Picture"
      class="img-thumbnail"> -->
...
export default {
  ...
  computed: {
    ...
    dayWeek() {
      const { dayWeek } = getDayMonthYear(this.entry.date)
      return dayWeek
    },
    year() {
